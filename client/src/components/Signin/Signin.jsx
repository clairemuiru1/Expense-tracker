        ...
        <div className='login-popup'>
            <form className="login-popup-container">
                ...
                <div className="login-popup-inputs">
                    {currentState === "login" ? <></> : <input type='text' placeholder='Your name' required onChange={(e) => setUsername(e.target.value)} />}
                    <input type='email' placeholder='Your email' required onChange={(e) => setEmail(e.target.value)} />
                    <input type='password' placeholder='Password' required onChange={(e) => setPassword(e.target.value)} />
                </div>
                <button onClick={currentState === "Sign Up" ? handleSignup : handleLogin}>{currentState === "Sign Up" ? "Create Account" : "Login"}</button>
